    ...
    <div class="relative h-56 overflow-hidden md:h-96">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            ...
            w-[80%] md:w-auto text-black">
                ...
                <button class="mt-2 m-auto md:m-0   w-fit p-2 md:p-5 bg-white rounded-xl border-1 border-gray-200 hover:bg-blue-200 duration-150 font-bold">Xem Ngay</button>
            </div>  
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out text-white" data-carousel-item>
            ...
            w-[80%] md:w-auto text-black">
                ...
                <button class="text-black mt-2 m-auto md:m-0 w-fit p-2 md:p-5 bg-white rounded-xl border-1 border-gray-200 hover:bg-blue-200 duration-150 font-bold">Tìm hiểu thêm</button>
            </div>  
        </div>
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out text-black" data-carousel-item>
            ...
            w-[80%] md:w-auto text-black">
                ...
                <button class="mt-2 m-auto md:m-0   w-fit p-2 md:p-5 bg-white rounded-xl border-1 border-gray-200 hover:bg-blue-200 duration-150 font-bold">Mua Ngay</button>
            </div>  
        </div>
        <!-- Item 4 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
