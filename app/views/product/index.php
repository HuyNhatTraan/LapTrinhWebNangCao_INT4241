                ...
                <form action="index.php?act=cart-add" method="POST">
                    <div class="xl:p-15 p-6 flex flex-col">
                        <?php foreach ($products as $product): ?>
                            ...
                            <span
                                class="xl:text-4xl text-4xl font-bold xl:mb-5 text-orange-500"><?= htmlspecialchars($product['TenSP']) ?></span>

                            <div class="flex items-center mt-3">
                                <span
                                    class="text-2xl font-bold xl:text-4xl xl:font-bold"><?= number_format($product['GiaHienTai'], 0, ',', '.') ?>đ</span>
                                <span
                                    class="text-lg xl:text-4xl text-[#757575] line-through ml-3"><?= number_format($product['GiaBase'], 0, ',', '.') ?>đ</span>
                            </div>
                        <?php endforeach; ?>
                        ...
                        <div class="flex items-center justify-between w-full mt-5 mb-5">
                            ...
                            <span
                                class="font-bold text-red-500 text-xl"><?= number_format($product['GiaHienTai'], 0, ',', '.') ?>đ</span>
                        </div>

                        <div class="w-full">
                            <button type="submit"
                                class="bg-red-500 text-white font-bold rounded-xl w-full p-4 hover:bg-red-800 duration-200 cursor-pointer">
                                Thêm vào giỏ hàng
                            </button>
                        </div>
                    </div>
