                    ...
                    <div class="xl:p-15 p-6 flex flex-col">
                        ...
                        <div class="flex items-center justify-between w-full mt-5 mb-5">
                            ...
                            <div class="relative flex items-center max-w-[8rem]">
                                ...
                                <input type="text" name="SoLuong" value="1" id="quantity-input" data-input-counter data-input-counter-min="1" data-input-counter-max="<? $product = $_SESSION['dungLuong']; echo $product['SoLuong']; ?>" aria-describedby="helper-text-explanation" class="bg-gray-50 border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
