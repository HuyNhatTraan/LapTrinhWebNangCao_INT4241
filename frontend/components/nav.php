...
<nav class="sticky top-0 z-10">
    <div class="flex h-14 items-center bg-white justify-between shadow-md">
        <div class="flex gap-4 ml-10 xl:ml-55 lg:ml-30 md:ml-10 sm:ml-20 md:gap-4 lg:gap-6  items-center">
            ...
            <div class="hidden font-sans gap-4 md:flex md:gap-4 lg:gap-6 2xl:gap-10">
                <a href="/LapTrinhWebNangCao_INT4241/frontend/pages/store">
                    <span class="cursor-pointer text-lg 2xl:text-sm xl:text-sm lg:text-sm md:text-[12px] hover:text-[#3c81c6] duration-150">
                        Cửa hàng</span>                      
                </a>
