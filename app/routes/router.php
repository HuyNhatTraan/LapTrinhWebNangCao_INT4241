...
$routes = [
    ...
    '/address/add' => ['controller' => 'UserInfoController', 'action' => 'themDiaChi'],
    '/address/delete' => ['controller' => 'UserInfoController', 'action' => 'xoaDiaChi'],
    '/address/edit' => ['controller' => 'UserInfoController', 'action' => 'suaDiaChi'],
