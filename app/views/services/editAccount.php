    ...
    <div class="flex items-center justify-center">
        <form class="bg-white w-[95%] md:w-[80%] p-5 md:p-10 rounded-2xl shadow-lg border-2 border-gray-300" method="POST" action="edit-user-info/submit">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">                
                ...
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">Email address <span class="text-gray-400">(Read Only)</span></label>
                ...
                <div>
                    <label for="NgayDangKy" class="block mb-2 text-sm font-medium text-gray-900 ">Ngày đăng ký <span class="text-gray-400">(Read Only)</span></label>
                    <input type="text" id="DiaChiGiaoHang" name="NgayDangKy" value="<?php echo $userInfo['NgayDangKy']; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Địa chỉ của bạn" readonly />
                </div>               
            </div>
            <div class="mb-6">
            ...
            <div class="flex justify-center gap-2 md:gap-5 flex-col md:flex-row">
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm md:text-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cập nhật thông tin</button>
                <a href="./address" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm md:text-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cập nhật địa chỉ giao hàng</a>
            </div>                        
            <?php endforeach; ?>   
        </form>
    </div>
