            ...
            <ul
                ...
                <li>
                    <a href="/LapTrinhWebNangCao_INT4241/frontend/pages/store/"
                        class="block py-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 dark:text-black md:dark:text-blue-500"
                ...
                <li>
                    <a href="/LapTrinhWebNangCao_INT4241/frontend/pages/smart-home/"
                ...
                <li>
                    <a href="/LapTrinhWebNangCao_INT4241/frontend/pages/discover/"
                ...
                <li>
                    <a href="/LapTrinhWebNangCao_INT4241/frontend/pages/support/"
                ...
                <li>
                    <a href="#" class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-black md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
