...
<body class="bg-gray-100 min-h-screen">
    <div class="flex min-h-screen bg-gray-50">
        <!-- Sidebar -->
        <aside class="w-72 bg-white shadow-xl h-full overflow-y-auto transition-all duration-300 z-50 border-r border-gray-200 
                      fixed lg:static left-0 top-0 -translate-x-full lg:translate-x-0" id="sidebar">
            <div class="p-4 sm:p-6 lg:p-10 border-b border-gray-200">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm">Quản lý hệ thống</p>
                    </div>
                </div>
            </div>
            <nav class="py-4 sm:py-6 px-4 sm:px-6" id="sidebar-tabs">
                <div class="space-y-3">
        ...
        <div class="flex-1 lg:ml-0">
            ...
            <header class="shadow-sm border-gray-200 sticky top-0 z-40 backdrop-blur-sm bg-white">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
                    <div class="flex items-center gap-4 sm:gap-6">
                        <button class="lg:hidden p-2 sm:p-3 rounded-xl hover:bg-gray-100 transition-colors" id="mobile-menu-btn">
                            <i class="fas fa-bars text-gray-600"></i>
                        </button>
                        <div>
                            <h1 class="text-xl sm:text-2xl font-bold text-gray-800" id="dashboard-title">Tổng quan</h1>
                            <p class="text-xs sm:text-sm text-gray-500 mt-1">Quản lý và theo dõi hoạt động của hệ thống</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2 sm:gap-4 lg:gap-6 mt-4 sm:mt-0">
                        <div class="relative">
                            <button class="p-2 sm:p-3 rounded-xl hover:bg-gray-100 transition-colors relative">
                        ...
                        <div class="flex items-center gap-2 sm:gap-4 pl-4 sm:pl-6 border-l border-gray-200">
                            <div class="text-right hidden sm:block">
                                <p class="text-xs sm:text-sm font-semibold text-gray-800">Admin User</p>
                                <p class="text-xs text-gray-500">Quản trị viên</p>
                            </div>
                            <div class="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg">
                                <img src="/LapTrinhWebNangCao_INT4241/frontend/icon.png" alt="Admin" class="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 rounded-lg sm:rounded-xl">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Dashboard content -->
            <main class="p-4 sm:p-6 lg:p-8 bg-gray-50 min-h-screen" id="dashboard-content">
                <!-- Tổng quan -->
                <div id="tab-overview" class="tab-content">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8 lg:mb-10">
                        <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm p-4 sm:p-6 lg:p-8 border border-gray-100 hover:shadow-md transition-shadow duration-300">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-xs sm:text-sm font-medium text-gray-600 mb-2">Đơn hàng hôm nay</p>
                                    <p class="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-600 mb-2">120</p>
                                    <p class="text-xs sm:text-sm text-green-600 flex items-center gap-1">
                                        <i class="fas fa-arrow-up"></i> 
                                        <span>+12% so với hôm qua</span>
                                    </p>
                                </div>
                                <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-lg">
                        ...
                        <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm p-4 sm:p-6 lg:p-8 border border-gray-100 hover:shadow-md transition-shadow duration-300">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-xs sm:text-sm font-medium text-gray-600 mb-2">Doanh thu hôm nay</p>
                                    <p class="text-2xl sm:text-3xl lg:text-4xl font-bold text-green-600 mb-2">2.5M₫</p>
                                    <p class="text-xs sm:text-sm text-green-600 flex items-center gap-1">
                                        <i class="fas fa-arrow-up"></i> 
                                        <span>+8% so với hôm qua</span>
                                    </p>
                                </div>
                                <div class="bg-gradient-to-r from-green-500 to-green-600 p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-lg">
                        ...
                        <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm p-4 sm:p-6 lg:p-8 border border-gray-100 hover:shadow-md transition-shadow duration-300">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-xs sm:text-sm font-medium text-gray-600 mb-2">Khách hàng mới</p>
                                    <p class="text-2xl sm:text-3xl lg:text-4xl font-bold text-yellow-600 mb-2">35</p>
                                    <p class="text-xs sm:text-sm text-green-600 flex items-center gap-1">
                                        <i class="fas fa-arrow-up"></i> 
                                        <span>+15% so với hôm qua</span>
                                    </p>
                                </div>
                                <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-lg">
                        ...
                        <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm p-4 sm:p-6 lg:p-8 border border-gray-100 hover:shadow-md transition-shadow duration-300">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-xs sm:text-sm font-medium text-gray-600 mb-2">Sản phẩm hết hàng</p>
                                    <p class="text-2xl sm:text-3xl lg:text-4xl font-bold text-red-600 mb-2">12</p>
                                    <p class="text-xs sm:text-sm text-red-600 flex items-center gap-1">
                                        <i class="fas fa-exclamation-triangle"></i> 
                                        <span>Cần nhập hàng</span>
                                    </p>
                                </div>
                                <div class="bg-gradient-to-r from-red-500 to-red-600 p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-lg">
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                        <div class="xl:col-span-2">
                            <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm p-4 sm:p-6 lg:p-8 border border-gray-100">
                                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6">
                                    <h3 class="text-lg sm:text-xl font-bold text-gray-800 mb-2 sm:mb-0">Đơn hàng gần đây</h3>
                                    <button class="px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-lg sm:rounded-xl hover:bg-blue-700 transition-colors text-xs sm:text-sm font-medium">
                                        Xem tất cả
                                    </button>
                                </div>
                        ...
                        <div class="space-y-4 sm:space-y-6 lg:space-y-8">
                            <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm p-4 sm:p-6 lg:p-8 border border-gray-100">
                                <h3 class="text-lg sm:text-xl font-bold text-gray-800 mb-4 sm:mb-6">Sản phẩm bán chạy</h3>
                                <div class="space-y-3 sm:space-y-4">
                                    <div class="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl hover:bg-gray-100 transition-colors">
                                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg sm:rounded-xl flex items-center justify-center">
                                            <i class="fas fa-mobile-alt text-white text-sm sm:text-base"></i>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <p class="font-semibold text-gray-800 text-sm sm:text-base truncate">iPhone 14 Pro</p>
                                            <p class="text-xs sm:text-sm text-gray-500">Đã bán: 45 sản phẩm</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl hover:bg-gray-100 transition-colors">
                                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-green-500 to-green-600 rounded-lg sm:rounded-xl flex items-center justify-center">
                                            <i class="fas fa-mobile-alt text-white text-sm sm:text-base"></i>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <p class="font-semibold text-gray-800 text-sm sm:text-base truncate">Samsung Galaxy S23</p>
                                            <p class="text-xs sm:text-sm text-gray-500">Đã bán: 32 sản phẩm</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl hover:bg-gray-100 transition-colors">
                                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg sm:rounded-xl flex items-center justify-center">
                                            <i class="fas fa-mobile-alt text-white text-sm sm:text-base"></i>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <p class="font-semibold text-gray-800 text-sm sm:text-base truncate">Xiaomi Mi 13</p>
                                            <p class="text-xs sm:text-sm text-gray-500">Đã bán: 28 sản phẩm</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-100">
                        <div class="p-4 sm:p-6 border-b border-gray-200">
                            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                <h2 class="text-lg sm:text-xl font-semibold">Quản lý đơn hàng</h2>
                                <div class="flex flex-wrap gap-2">
                                    <button class="order-filter-btn active px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-lg text-xs sm:text-sm" data-status="all">
                                        Tất cả
                                    </button>
                                    <button class="order-filter-btn px-3 sm:px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-xs sm:text-sm hover:bg-gray-200" data-status="new">
                                        Mới
                                    </button>
                                    <button class="order-filter-btn px-3 sm:px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-xs sm:text-sm hover:bg-gray-200" data-status="processing">
                                        Đang xử lý
                                    </button>
                                    <button class="order-filter-btn px-3 sm:px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-xs sm:text-sm hover:bg-gray-200" data-status="completed">
                                        Hoàn tất
                                    </button>
                                    <button class="order-filter-btn px-3 sm:px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-xs sm:text-sm hover:bg-gray-200" data-status="cancelled">
                                        Đã hủy
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="p-4 sm:p-6">
                            <div class="overflow-x-auto -mx-4 sm:-mx-6">
                                <div class="inline-block min-w-full py-2 align-middle px-4 sm:px-6">
                                    <table class="min-w-full text-xs sm:text-sm">                                        <thead>
                                            <tr class="border-b border-gray-200">
                                                <th class="text-left py-3 px-2 sm:px-4 font-medium text-gray-600">Mã đơn</th>
                                                <th class="text-left py-3 px-2 sm:px-4 font-medium text-gray-600">Khách hàng</th>
                                                <th class="text-left py-3 px-2 sm:px-4 font-medium text-gray-600 hidden sm:table-cell">Ngày đặt</th>
                                                <th class="text-left py-3 px-2 sm:px-4 font-medium text-gray-600">Tổng tiền</th>
                                                <th class="text-left py-3 px-2 sm:px-4 font-medium text-gray-600">Trạng thái</th>
                                                <th class="text-left py-3 px-2 sm:px-4 font-medium text-gray-600">Thao tác</th>
                                        </tr>
                                    </thead>                                        <tbody>
                                            <tr class="border-b border-gray-100">
                                                <td class="py-3 px-2 sm:px-4 font-medium">#1001</td>
                                                <td class="py-3 px-2 sm:px-4">Nguyễn Văn A</td>
                                                <td class="py-3 px-2 sm:px-4 hidden sm:table-cell">11/07/2025</td>
                                                <td class="py-3 px-2 sm:px-4">1,200,000₫</td>
                                            <td class="py-3 px-4">
    ...
    tabBtns.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            // Update title
            dashboardTitle.textContent = tabTitles[tab] || 'Dashboard';                            // Hide sidebar on mobile after selection
