    ...
    <div class="w-full h-[100%] relative shrink-0">
        ...
        <div class="hidden md:absolute inset-0 md:flex justify-center items-center">
            <?php if (!isset($_SESSION['user'])): ?>
                ...
                <div class='flex items-center gap-6 p-4'>
                    <div class='flex flex-col justify-center items-center gap-4'>
                        <svg width='64px' height='64px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                            ...
                            <path d='M9.00012 9L15.0001 15' stroke='#ffffff' stroke-width='1.5' stroke-linecap='round'>
                            </path>
                ...
                <?php exit(); endif; ?>
            <div class="w-[90%] flex justify-between items-center gap-4 p-4 rounded-xl shadow-[2px_1px_10px_8px_rgba(0,_0,_0,_0.35)] text-2xl text-white">
                <?php if (isset($_SESSION['user'])): ?>
                    <div class="flex items-center justify-center gap-6 p-4">
                        <img class="w-[120px] h-[120px] object-cover rounded-full border-2 border-white shadow"
                                ...
                                <g id='SVGRepo_iconCarrier'>
                                    ...
                                    <g id='layer1' transform='translate(-300,-484)'>
                                        <path
                                            ...
                                            id='path453753'
                                            style='color:#ffffff;fill:#ffffff;fill-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4.1;'>
                                        </path>
                                        <path
                    ...
                    <div class='flex items-center gap-6 p-4'>
                        <div class='flex flex-col items-center gap-2'>
                            <a class='text-xl font-bold underline hover:text-[#3c81c6] duration-150'
                                href='routes/logout.php'>Đăng xuất</a>
                        </div>
                    </div>
                <?php else: ?>
                    <div class='flex items-center gap-6 p-4'>
                        <div class='flex flex-col items-center gap-4'>
                            <span class='text-3xl font-semibold text-white'>Không tìm thấy kết quả. Vui lòng đăng nhập
                                lại</span>
                        </div>
                    </div>
                <?php endif; ?>
        ...
        <div class="w-[90%] mt-5 shadow-lg rounded-xl bg-white flex flex-col items-center justify-center gap-3 p-4">
            ...
            <div class='flex flex-col justify-center text-center'>
                ...
                <div class="flex gap-3">
                    <a href='./edit-user-info'>
                        <button class='text-xs mt-3 hover:text-[#3c81c6] duration-200 p-2 border-2 border-gray-300 rounded-xl bg-amber-100'>Chỉnh sửa thông tin</button>
                    </a>
                    <a href='routes/logout.php'>
                        <button class='text-xs mt-3 hover:text-[#3c81c6] duration-200 p-2 border-2 border-gray-300 rounded-xl bg-blue-100'>Đăng xuất</button>
                    </a>
                </div>
