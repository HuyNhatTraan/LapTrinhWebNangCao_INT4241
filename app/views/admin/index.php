    ...
    <nav class="bg-gray-800">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="-mr-2 flex xl:hidden">
                    ...
                    <button type="button" id="mobile-menu-button" aria-controls="mobile-menu" aria-expanded="false"
                        ...
                        <svg id="menu-open-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
                            aria-hidden="true" class="block size-6">
                            <path d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                        <!-- Menu open: "block", Menu closed: "hidden" -->
                        <svg id="menu-close-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
        ...
        <div id="mobile-menu" class="xl:hidden hidden">
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                ...
                <a href="?page=don-hang"
                    class="block rounded-md <?php echo $page == 'don-hang' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?> px-3 py-2 text-base font-medium">Quản lý đơn hàng</a>
                <a href="?page=khach-hang"
                    class="block rounded-md <?php echo $page == 'khach-hang' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?> px-3 py-2 text-base font-medium">Quản lý khách hàng</a>
                <a href="?page=danh-muc"
                    class="block rounded-md <?php echo $page == 'danh-muc' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?> px-3 py-2 text-base font-medium">Quản lý danh mục</a>
                <a href="?page=san-pham"
                    class="block rounded-md <?php echo $page == 'san-pham' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?> px-3 py-2 text-base font-medium">Quản lý sản phẩm</a>
                <a href="?page=thong-ke"
                    class="block rounded-md <?php echo $page == 'thong-ke' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?> px-3 py-2 text-base font-medium">Thống kê và báo cáo</a>
            </div>
